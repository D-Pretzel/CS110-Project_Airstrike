...
# Authors: C4C Petzold & C4C Cho
# Course: CS110, Fall 2021
# Final Turn-in Options: 1, 5
# DOCUMENTATION: C/4C Anderson assisted in logic surrounding drone_bomber bombing behavior

'''
#! Gate Check Requirements:
    #* 1. Identify the location of at least one (of several) enemy bases by scanning with the recon drone
...
def is_empty_scan(scan):
    ...
    if len(scan) != 0:
        all_targets += scan  # concatonates all data to all_targets (replacement for flattening) --- "all_targets" is 2D
